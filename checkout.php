...
$cart_items = mysqli_query($conn, "SELECT c.*, cl.title, cl.price, cl.image_url FROM tblCart c JOIN tblClothes cl ON c.clothing_id = cl.clothing_id WHERE c.buyer_id = $buyer_id");
$total = 0;
        ...
        <div class="checkout-layout">
            ...
            <form method="POST" class="checkout-form">
                ...
                <div class="button-group">
                    ...
                    <a href="cart.php" class="btn-cancel">Cancel & Return to Cart</a>
                </div>
            ...
            <div class="order-summary">
                ...
                <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid var(--border);">
                    <p style="font-size: 0.7rem; color: var(--text-muted); text-align: center;">
                        By completing this purchase, you agree to the Pastimes Terms of Authentication and Secure Escrow Service.
                    </p>
                </div>
            </div>
        </div>
